...
use App\Models\ProfileHashtag;
use App\Models\Role;
use App\Models\RoleUser;
use App\Models\Tooti;
use App\Models\TootiHashtag;
...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        HashtagComment::factory(10)->create();
        ProfileHashtag::factory(10)->create();
        TootiHashtag::factory(10)->create();
